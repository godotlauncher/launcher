...
type ChangeProjectEditorResult = AddProjectToListResult;
...
interface Window {
    electron: {
        ...
        addProject: (path: string, release: InstalledRelease) => Promise<AddProjectToListResult>;
