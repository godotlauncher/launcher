                ...
                <div className="flex flex-col gap-4 p-1">
                    <div className="flex flex-col gap-2">
                        <div className="flex flex-row gap-2 items-center">
                            ...
                            {installedReleases[releaseIndex]?.mono && <p className="badge badge-outline text-base-content/50">.NET</p>}
                            {installedReleases[releaseIndex]?.prerelease && <p className="badge badge-outline text-base-content/50">prerelease</p>}
                        </div>
