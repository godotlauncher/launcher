...
export const InstallEditorSubView: React.FC<SubviewProps> = ({ onClose }) => {
    ...
    const [tab, setTab] = useState<'RELEASE' | 'PRERELEASE' | 'INSTALLED'>(
        'RELEASE',
    );
    ...
    const getFilteredRows = () => {
        if (tab === 'RELEASE') {
            ...
            if (textSearch === '')
                return prereleases.filter((row) => row.prerelease);
            ...
            <div className="absolute inset-0 px-8 pb-8 flex flex-col w-full h-full overflow-hidden items-center z-20">
                <div className="flex flex-col p-4 rounded-b-lg overflow-hidden bg-base-300  min-w-[900px]">
                    <div className="flex flex-col gap-2 w-full">
                        <div className="flex flex-row justify-between items-start">
                            ...
                            <div className="flex gap-2">
                                <button type="button" onClick={onClose} data-testid="btnCloseInstallEditor">
                                    <X />
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-row justify-between">
                        ...
                        <div
                            role="tablist"
                            className="tabs tabs-border flex flex-1 flex-row "
                        >
                            <button
                                type="button"
                                role="tab"
                                ...
                                className={clsx(
                                    'tab w-[150px] justify-start pl-4',
                            ...
                            >
                                <div className="flex gap-2 items-center">
                                    ...
                                    {installedReleases
                                        .reduce((acc, i) => {
                                            acc += i.prerelease ? 0 : 1;
                                            return acc;
                                        }, 0)
                                        .toString()}
                                    )
                                    {downloadingReleases.reduce((acc, i) => {
                                        acc += i.prerelease ? 0 : 1;
                                        return acc;
                                    }, 0) > 0 && (
                        ...
                        <div className="flex flex-row gap-2 items-center">
                            <span
                                className="flex items-center tooltip text-info"
                                data-tip={t('filters.showInstalledOnly')}
                            >
                            ...
                            <button
                                type="button"
                                onClick={refreshAvailableReleases}
