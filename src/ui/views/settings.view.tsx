        ...
        <div className="flex flex-col h-full w-full p-1">
            ...
            <div className="flex flex-col gap-0 flex-1">
                ...
                <div role="tablist" className="flex tabs tabs-lift">
                    ...
                    <button
                        type="button"
                        data-testid="tabInstalls"
                        onClick={() => setActiveTab('installs')}
                        role="tab"
                        className={clsx('tab', {
                            'tab-active': activeTab === 'installs',
                        })}
                    >
                        {t('tabs.installs')}
                    </button>
                    <button
                        type="button"
                        data-testid="tabAppearance"
                        onClick={() => setActiveTab('appearance')}
                        role="tab"
                        className={clsx('tab', {
                            'tab-active': activeTab === 'appearance',
                        })}
                    >
                        {t('tabs.appearance')}
                    </button>
                    <button
                        type="button"
                        data-testid="tabBehavior"
                        onClick={() => setActiveTab('behavior')}
                        role="tab"
                        className={clsx('tab', {
                            'tab-active': activeTab === 'behavior',
                        })}
                    >
                        {t('tabs.behavior')}
                    </button>
                    <button
                        type="button"
                        data-testid="tabTools"
                        onClick={() => setActiveTab('tools')}
                        role="tab"
                        className={clsx('tab', {
                            'tab-active': activeTab === 'tools',
                        })}
                    >
                        {t('tabs.tools')}
                    </button>
                    <button
                        type="button"
                        data-testid="tabUpdates"
                        onClick={() => setActiveTab('updates')}
                        role="tab"
                        className={clsx('tab', {
                            'tab-active': activeTab === 'updates',
                        })}
                    >
                        {t('tabs.updates')}
                    </button>
                ...
                >
                    <div className="flex-1 overflow-y-auto px-6">
                        {/* Projects */}
                        <div
                            className={clsx('flex flex-col h-0 gap-4', {
                                ...
                                <div className=" flex flex-col gap-8">
                                    <label className="flex flex-row items-start cursor-pointer gap-4">
                                        <input
                                            ...
                                            checked={
                                                preferences?.confirm_project_remove
                                            }
                                            onChange={(e) => {
                                                if (preferences) {
                                                    savePreferences({
                                        ...
                                        <span className="">
                                            {t(
                                                'behavior.projects.confirmRemove',
                                            )}
                                        </span>
                                    </label>
                                </div>
