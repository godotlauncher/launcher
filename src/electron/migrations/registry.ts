...
export const migrations = [
    {
        ...
        description: 'Rebuild release caches to ensure Windows ARM64 assets are available.',
        options: {
            targetVersion: '1.6.1',
        },
        predicate: ({ currentVersion, lastSeenVersion, options }) => {
            ...
            const targetVersion = typeof options?.targetVersion === 'string' ? options.targetVersion : '0.0.0';
