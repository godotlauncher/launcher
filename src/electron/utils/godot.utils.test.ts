    ...
    describe('Project template for version 5', () => {
        it('should render forward plus godot project file', async () => {
            ...
            expect(
                ...
                `config_version=5[application]config/name="test"config/features=PackedStringArray("4.4")config/icon="res://assets/icon.svg"`,
            );
        });
        ...
        it('should render mobile godot project file', async () => {
            ...
            expect(
                ...
                `config_version=5[application]config/name="test"config/features=PackedStringArray("4.4")config/icon="res://assets/icon.svg"[rendering]renderer/rendering_method="mobile"`,
            );
        });
        ...
        it('should render gl compatibility godot project file', async () => {
            ...
            expect(
                ...
                `config_version=5[application]config/name="test"config/features=PackedStringArray("4.4")config/icon="res://assets/icon.svg"[rendering]renderer/rendering_method="gl_compatibility"renderer/rendering_method.mobile="gl_compatibility"`,
            );
        });
    });
