...
import { ToolsSettingsPanel } from './tools-settings-panel.component';
...
describe('ToolsSettingsPanel', () => {
    it('renders a generic tool card with display-safe installation data', () => {
        ...
        expect(html).toContain('aria-label="tools.actions.rescanTool: Git"');
        expect(html).toContain('aria-label="tools.actions.editTool: Git"');
    });
