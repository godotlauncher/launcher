...
import { CodeEditorSettingsPanel } from './code-editor-settings-panel.component';
...
/**
 * Renders the panel with stable translation keys and mocked actions.
 * @param overrides - Props to vary for the state under test.
...
describe('CodeEditorSettingsPanel', () => {
    it('renders detected integration details', () => {
        ...
        expect(html).toContain('.NET codeEditors.drawer.dotnet.supported');
    ...
    it('omits the .NET badge when the integration does not support it', () => {
        ...
        expect(html).not.toContain('.NET codeEditors.drawer.dotnet.supported');
    });
