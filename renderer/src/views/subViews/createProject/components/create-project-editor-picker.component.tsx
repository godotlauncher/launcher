...
/**
 * Renders a compact editor field backed by a rich anchored popover.
 *
...
> = ({
    ...
    const triggerId = `selectCreateProjectGodotEditor-${reactId}`;
    ...
    return (
        <div className="relative min-w-0">
            <button
                ...
                className="select select-bordered select-sm flex w-full items-center justify-between gap-2 bg-[var(--select-field-background)] text-left text-sm"
                onClick={() =>
