...
import { SearchField } from '../../../components/ui/search-field.component.tsx';
...
/**
 * Renders all matching releases in version groups.
 *
...
export const InstallEditorAll: React.FC<InstallEditorAllProps> = ({
    ...
    return (
        <div className="flex h-full min-h-0 flex-col gap-2">
            ...
            {releases.length === 0 ? (
                <div className="flex min-h-0 flex-1 items-center justify-center text-base-content/75">
                    {emptyLabel}
                </div>
            ) : (
                <div
                    className="flex min-h-0 flex-1 flex-col overflow-auto pr-3"
...
const ReleaseRow: React.FC<ReleaseRowProps> = ({
    ...
    <article className="flex min-h-14 flex-col items-stretch gap-3 px-3 py-3 hover:bg-base-content/5 sm:flex-row sm:items-center">
