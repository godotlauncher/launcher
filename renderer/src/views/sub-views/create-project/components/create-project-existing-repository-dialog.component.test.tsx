...
describe('CreateProjectExistingRepositoryDialog', () => {
    it('shows the warning with Cancel and Continue', () => {
        ...
        expect(html).toContain('existingRepository.warningMessage:');
        expect(html).toContain('/projects/parent');
    ...
    it('shows the local completion state with Done', () => {
        ...
        expect(html).toContain('existingRepository.completionMessage:');
        expect(html).toContain('/projects/parent');
