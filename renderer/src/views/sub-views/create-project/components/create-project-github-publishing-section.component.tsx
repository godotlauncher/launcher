...
> = ({
    ...
    return (
        <section className="rounded-md bg-base-200/40 px-4 py-2 text-base">
            <div>
                {loading ? (
                    <div
                    ...
                    <div
                        className="alert alert-warning alert-soft flex flex-wrap items-center justify-between gap-3 text-base text-warning-content dark:text-warning"
                        role="status"
                    >
                        <span>
                            {t(
