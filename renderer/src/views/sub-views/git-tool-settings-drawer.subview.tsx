                ...
                {!loading && !loadError && form && settings && (
                    <>
                        <section className="flex flex-col gap-[12px]">
                            ...
                            <button
                                type="button"
                                className="btn btn-primary self-end text-base"
                                disabled={disabled || !available}
                        ...
                        <section className="flex flex-col gap-[12px]">
                            ...
                            />
                            <label
                                htmlFor="gitIdentityUseForNewRepositories"
                                className="flex items-start justify-between gap-4 bg-base-200/60 p-4"
                            >
                                <span>
                                    ...
                                    <span className="mt-[4px] block text-base-content/75">
                                        {t(
                                ...
                                <span className="flex h-5 shrink-0 items-center">
                                    <Switch
                                        id="gitIdentityUseForNewRepositories"
                                        checked={
                                            form.projectPreset
