        ...
        <div className="flex flex-col gap-4 text-sm">
                    ...
                    <div className=" flex flex-row gap-4">
                        <div className="flex flex-row flex-shrink items-center justify-start gap-4 ">
                            <input
                                ...
                                type="radio"
                                name="launch-action"
                                className="radio-sm checked:bg-current"
                                checked={
                                    preferences?.post_launch_action === 'none'
                                }
                            />
                            <span className="">
                                {t('customizeBehavior.nothing')}
                            </span>
                        </div>
                        <div className="flex flex-row flex-shrink items-center justify-start gap-4 ">
                            <input
                        ...
                        <div className="flex flex-row flex-shrink items-center justify-start gap-4 ">
                            ...
                            />
                            <span className="">
                                {t('customizeBehavior.closeToTray')}
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div className=" flex flex-row gap-4">
                <div className="flex flex-row flex-shrink items-center justify-start gap-4 ">
                    ...
                    />
                    <span className="">
                        {t('customizeBehavior.autoCheckUpdates')}
                    </span>
                </div>
            </div>
            ...
            <div>
                <div className="flex flex-col flex-shrink items-start  gap-0 ">
                    ...
                    <label
                        className={clsx('label flex flex-row gap-4 pl-12', {
                            'cursor-not-allowed':
